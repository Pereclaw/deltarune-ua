...
Переклад тексту: [100%]
<br>Редактура перекладу: [100%]
<br>Вичитка: невдовзі почнеться!
<br>Переклад текстур: [96%]
<br>Озвучення: більша частина готова та імплементована в гру.

<br>**Якщо вам цікаво, є записи проходження 1 та 2 розділів українськими стрімерами та нумограйниками (летсплеєрами), які ви можете переглянути за цими посиланнями:**

### YouTube
[Записи стримів](https://www.youtube.com/playlist?list=PLIoSWbHAMmkG7FvEuv_QZ13CTOCwt-7Ii)

[Нумограї](https://www.youtube.com/playlist?list=PLIoSWbHAMmkH9VEmuli16M70ibC8sPCBF&si=aMkWy8sSiEqcwiQE)

# Посилання

### Завантаження локалізації
[Github](https://github.com/pereclaw/deltarune-ua/releases)
<br><br>[KULI](https://kuli.com.ua/deltarune#translations)
<br><br>[Nexusmods](https://www.nexusmods.com/deltarune/mods/8?tab=files)
...
<a href="https://t.me/pereclaws"><img alt="Telegram" src="https://img.shields.io/badge/Pereclaw?link=https://t.me/pereclaws&label=Pereclaw&logo=telegram&style=social&message=локалізація ігор"></a>
...
- pita_guy (Локалізація 3 і 4 розділів) — [Discord](https://discordapp.com/users/529280743705149452)

### Перекладачі:
- yanchukcha (1 і 2 розділи) — [Discord](https://discordapp.com/users/366303194688782336)
...
### Озвучення Джиявола:
- LostHuman (Голос) — [Youtube](https://www.youtube.com/@Lost_HumanVO)
- yanchukcha (Обробка)
- DanielleTlumach (Режисерування)

### Don't Forget — “Не забудь” (Вокальний уривок):
- neonbonbon (Вокал) — [Twitch](https://www.twitch.tv/neonbonbon?sr=a)
- FulminisIctus (Інструментал) — [Youtube](https://www.youtube.com/c/FulminisIctus)
- yanchukcha (Обробка)
- DanielleTlumach (Режисерування)

### Музичні теми Спамтона:
- Ілля Янчицький (Голос)
- nini (Інструментал) — [Youtube](https://www.youtube.com/@reiiini)
- AevilJ (Інструментал) — [Youtube](https://www.youtube.com/@AevilJ)
- yanchukcha (Обробка)
...
- Ілля Янчицький (<i>“В БІЙ!”</i>)
- Мар'яна Янкевич (<i>“РАУНД X!”</i>)
...
### Окрема подяка
- [Florentia Mysteria](https://github.com/florik-florentia) (Ранні версії перекладу)
- MrMult (Скрипт для витягування тексту з файлів)
- [INDMops](https://github.com/IndiMops)
- Ростік (Натхнення)
